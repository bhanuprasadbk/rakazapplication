...
export class SidenavComponent implements OnInit {
  ...
  bottomNavLinks = [
    { icon: 'bi-gear', tooltip: 'Configuration', link: 'configuration' },
    { icon: 'bi-bell', tooltip: 'Notification', link: 'notification' },
    { icon: 'bi-person-circle', tooltip: 'Profile', link: 'profile' }
  ];
